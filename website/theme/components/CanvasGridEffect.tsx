...
/**
 * The same cursor-driven canvas grid used by the A3S Code project page.
 * It stays outside the content tree and never intercepts interaction.
 */
  ...
  useEffect(() => {
    ...
    const interactionTarget =
      interactionScope === 'page'
        ? (canvas.closest<HTMLElement>('.as-home') ?? host)
        : host;
