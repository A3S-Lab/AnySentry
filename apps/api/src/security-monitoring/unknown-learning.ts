...
const CANONICAL_EVENT_KINDS = new Set([
  'Exec', 'ToolExec', 'Exit', 'FileAccess', 'FileDelete', 'Egress', 'Dns', 'Tls', 'LlmCall', 'LlmInteraction', 'AgentPlaintextEvidence',
...
function canonicalEventKind(raw: unknown): string | undefined {
  ...
  const aliases: Record<string, string> = {
    ...
    tls: 'Tls', llm: 'LlmCall', llmcall: 'LlmCall', llminteraction: 'LlmInteraction', agentplaintextevidence: 'AgentPlaintextEvidence', ssl: 'SslContent', sslcontent: 'SslContent',
