...
export class SentryJudgeService implements OnModuleInit, OnModuleDestroy {
  ...
  recordCollectorHeartbeat(
    ...
    const filterMetrics: import('./types').CollectorFilterMetrics = {
      ...
      processLaunchContextProcReads: clamp(rawFilter.processLaunchContextProcReads),
      processLaunchContextEnvironmentReads: clamp(rawFilter.processLaunchContextEnvironmentReads),
      launchSystemdQueries: clamp(rawFilter.launchSystemdQueries),
      launchSystemdCacheHits: clamp(rawFilter.launchSystemdCacheHits),
      launchSystemdErrors: clamp(rawFilter.launchSystemdErrors),
      launchSystemdCacheEntries: clamp(rawFilter.launchSystemdCacheEntries),
